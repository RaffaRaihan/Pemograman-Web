    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsDefault">
            ...
            <ul class="navbar-nav ml-auto align-items-center">
                ...
                <a class='dropdown-item active' href='kategori.php'>Kategori</a>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#edit<?php echo $data['kategoriid'] ?>">
                                                Edit
                                            </button>
                                            <!-- Modal -->
                                            <div class="modal fade" id="edit<?php echo $data['kategoriid'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['kategoriid'] ?>">
                                                Hapus
                                            </button>
                                            <!-- Modal -->
                                            <div class="modal fade" id="hapus<?php echo $data['kategoriid'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="aksi_kategori.php" method="POST">
                                                                <input type="hidden" name="kategoriid" value="<?php echo $data['kategoriid'] ?>">
                                                                Apakah anda yakin akan menghapus data <strong> <?php echo$data['nama_kategori']?></strong> ?
                                                        </div>
                                                        <div class="modal-footer">
